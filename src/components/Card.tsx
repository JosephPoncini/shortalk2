...
const Card = (props: { top: string, bottom: string, isGuessing: boolean, isAnimated: boolean }) => {
  return (
    <div className={` ${props.isAnimated && 'barrelRoll'} w-[100px] h-[175px] sm:h-[50vh] sm:w-[275px] flex flex-col justify-center rounded-xl border-2 border-black bg-dblue text-center py-2 sm:py-12 relative`}>
      {props.isGuessing ?
