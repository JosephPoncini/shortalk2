...
const OnePointBtn = ({onClick} : {onClick:()=>void}) => {
  return (
    <div onClick={onClick} className=' rounded-2xl border-2 border-black w-[100px] sm:w-[200px] sm:h-[75px] bg-lgreen flex justify-between items-center px-4 space-x-4 cursor-pointer'>
