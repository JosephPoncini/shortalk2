...
const SkipBtn = ( {onClick} : {onClick:()=>void}) => {
  return (
    <div onClick={onClick} className=' rounded-lg sm:rounded-2xl border-2 border-black w-[100px] sm:w-[200px] sm:h-[75px] bg-lgray flex justify-between items-center px-4 cursor-pointer'>
